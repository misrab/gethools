...
gulp.task('geth', shell.task([
  ...
  'geth --mine --genesis ~/geth/test_genesis.json --port "30304" --networkid 9347  --datadir ~/.misrab_testnet --nodiscover --maxpeers 0  --rpcport "8546" --rpc --rpcapi "eth,web3,personal" --rpccorsdomain "http://localhost:3000" console' //2>> test.log',
]));
